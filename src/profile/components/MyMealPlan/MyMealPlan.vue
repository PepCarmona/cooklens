...
const RecipesListAndSearch = defineAsyncComponent(
  () => import('../../../recipes/components/RecipesListAndSearch.vue')
);
const RecipeDetails = defineAsyncComponent(
  () => import('../../../recipes/components/RecipeDetails.vue')
);
const CreateRecipe = defineAsyncComponent(
...
const currentMonth = computed(() => {
  const currentWeek = showingWeek.value.filter((day) => day !== null) as Day[];
...
function showMoreInfo(recipe: ClientRecipe) {
